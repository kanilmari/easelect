...
func main() {
	...
	// 9) Käynnistetään palvelin. Kääritään ensin FirewallHandler, sitten CSP.
	firewallWrappedHandler := firewall.FirewallHandler(http.DefaultServeMux)
	wrappedHandler := middlewares.WithCSP(firewallWrappedHandler)
