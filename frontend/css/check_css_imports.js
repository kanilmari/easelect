...
// Käyttö:
//    node check_import_paths.js import.css
// tai:
//    node check_import_paths.js ./frontend/css/imports.css
// */
// /* check_import_paths.js
//    Käyttö:
//       node check_import_paths.js import.css
...
// function tarkista_import_tiedostot() {
//   const import_tiedosto = process.argv[2] || 'import.css';

//   fs.readFile(import_tiedosto, 'utf8', (err, sisalto) => {
//     if (err) {
//       console.error(`\x1b[31mvirhe: tiedoston lukeminen epäonnistui: ${err.message}\x1b[0m`);
//       return;
//     }
...
//       - Ensimmäinen osa kattaa esim. @import url("joku.css")
//       - Toinen osa kattaa @import "joku.css" 
//     */
//     const import_kaava = /@import\s*(?:url\(\s*(['"])([^'"]+)\1\s*\)|(['"])([^'"]+)\3)/g;
//     let osuma;
...
//     while ((osuma = import_kaava.exec(sisalto)) !== null) {
//       // osuma[2] on polku, jos tuli url("..."),
//       // osuma[4] on polku, jos tuli "..."
//       const polku_css = osuma[2] || osuma[4];
//       if (!polku_css) {
//         // Ei pitäisi tapahtua, mutta varmistus.
//         continue;
//       }
//       yhteensa++;
...
//       console.log('\x1b[33mEi löytynyt lainkaan @import -rivejä.\x1b[0m');
//     } else if (virheita === 0) {
//       console.log(`\x1b[32mKaikki ${yhteensa} importtia OK.\x1b[0m`);
//     } else {
//       const onnistuneet = yhteensa - virheita;
//       console.log(`\x1b[31m${virheita} virhettä\x1b[0m, \x1b[32m${onnistuneet} OK\x1b[0m, yhteensä ${yhteensa} importtia.`);
//     }
//   });
// }

// tarkista_import_tiedostot();
