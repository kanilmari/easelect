...
export class TableComponent {
     ...
     *    Jokainen objekti vastaa yhtä riviä, esim. [{ id:1, nimi:'Testi' }, ...].
     * @param {Array<Object>} params.headers - Sarakkeiden määrittely taulukkona.
     *    Jokainen alkio on muodossa { label: 'Sarakeotsikko', key: 'id' }.
    ...
    constructor({ data, headers, initialView = 'normal' }) {
        ...
        // Lajittelusuunnat (avain = header.key, arvo = 'asc'/'desc')
        this.sortDirections = {};
        this.headers.forEach(h => {
            this.sortDirections[h.key] = 'asc';
        });

        // Filtterit (avain = header.key, arvo = string)
        this.filterCriteria = {};
        this.headers.forEach(h => {
