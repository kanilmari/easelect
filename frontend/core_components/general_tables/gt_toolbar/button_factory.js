...
export function createDeleteSelectedButton(table_name, current_view) {
    ...
    svgTrash.innerHTML = `
        <path d="m336-280 144-144 144 144 56-56-144-144 144-144-56-56-144 144-144-144-56 56
        144 144-144 144 56 56ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560
        q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z"/>
    `;
...
// // File: button_factory.js 2025-03-15--18-35
...
// /**
//  * Luo dropdown-napin, josta voi valita table/card/tree -näkymän
//  * HUOM: Käytämme luokkaa "view-selector-dropdown" 
...
// /**
//  * Luo column visibility -dropdownin (näkyvät sarakkeet)
//  * HUOM: Tälle annamme .custom-dropdown -luokan.
//  */
// export function createColumnVisibilityDropdownButton(tableContainer) {
//     const dropdown = createColumnVisibilityDropdown(tableContainer);
//     return dropdown || null;
