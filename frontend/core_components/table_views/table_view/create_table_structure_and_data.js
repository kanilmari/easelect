...
import { handleSortClick } from '../../general_tables/gt_crud/gt_read/handle_sort_and_search.js';
import { initialize_column_resizing } from './column_resizing.js';
import { refresh_table } from '../../general_tables/gt_crud/gt_read/table_refresh_collector.js'; // <-- suora import
...
function createFilterCell(column, table_name) {
    ...
    filter_input.addEventListener('keyup', () => refresh_table(table_name, { skipUrlParams: true }));
