...
function buildSearchRow(tableName) {
    ...
    function commitSearch() {
        ...
        localStorage.setItem(STORAGE_KEY_HISTORY, JSON.stringify(history.slice(-50))); // säilytä max 50
...
function buildFilterSection(tableName, columns, dataTypes) {
    ...
    return create_collapsible_section("Järjestä ja suodata", mainFilterContainer, true);
}
...
/* ===========================================================
 *  Älykäs haku – /intelligent-results
 * =========================================================*/
...
async function showReadOnlyTable(tableName, columns, data, types) {
    ...
    console.warn("showReadOnlyTable: generate_table ei palauttanut elementtiä");
    }
   }
