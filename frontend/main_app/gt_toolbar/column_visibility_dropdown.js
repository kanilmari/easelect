...
//             columns.push({
//                 name: columnName,
//                 visible: visibilitySettings.hasOwnProperty(columnName) ? visibilitySettings[columnName] : !th.classList.contains('hidden'),
...
//         const isVisible = visibilitySettings.hasOwnProperty(columnName) ? visibilitySettings[columnName] : true;
