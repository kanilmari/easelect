...
// // TUONTI: GPT:n avausfunktiot
// // import { open_prompt_modal_for_table } from '../../../common_actions/openai/openai_sql_modal.js';

// /**
//  * Pieni apufunktio korvaamaan alaviivat wbr:llä,
//  * ettei pitkät taulunnimet riko layouttia.
//  */
// function insertWbrForUnderscores(str) {
//     return str.replaceAll("_", "_<wbr>");
// }
...
//     if (toolbar) {
//         // Päivitetään olemassaolevaa toolbaria...
//         // (voisit siirtää viittaukset olemassaoleviin nappeihin, jos haluat)
//     } else {
//         // Luodaan toolbar ensimmäistä kertaa
//         toolbar = document.createElement('div');
//         toolbar.id = `${table_name}_toolbar`;
...
//         // gpt_button.textContent = 'GPT-lause';
//         // gpt_button.classList.add('gpt_table_button');
//         // gpt_button.addEventListener('click', () => {
//         //     // Avataan GPT-prompt nimenomaan tälle taululle
//         //     open_prompt_modal_for_table(table_name);
//         // });
//         // toolbar.appendChild(gpt_button);
