...
import { fetch_columns_for_table } from '../gt_crud/gt_read/endpoint_column_fetcher.js';
...
//     modalContent.style.gridGap = '10px';
//     modalContent.style.backgroundColor = 'var(--bg_color)';
//     modalContent.style.color = 'var(--text_color)';
//     modalContent.style.border = '1px solid var(--border_color)';
//     modalContent.style.padding = '10px';

//     const form = document.createElement('form');
//     form.id = 'column_management_form';
//     form.style.display = 'grid';
//     form.style.gridGap = '5px';

//     const title = document.createElement('h3');
//     // title.textContent = `Muokkaa taulun ${table_name} kenttiä`;
//     title.textContent = "";
//     //lisää data-lang-key
//     title.setAttribute('data-lang-key', 'manage_table');
...
//     formActions.style.gridTemplateColumns = 'auto auto auto';
//     formActions.style.gridGap = '10px';
...
//     // UUSI: Poista koko taulu -painike
//     const deleteTableButton = document.createElement('button');
//     deleteTableButton.type = 'button';
//     deleteTableButton.textContent = 'Poista koko taulu';
//     deleteTableButton.style.backgroundColor = 'red';
...
//         }
//     });
//     formActions.appendChild(deleteTableButton);

//     form.appendChild(formActions);
//     modalContent.appendChild(form);

//     // Korvataan kovakoodattu "Hallitse kenttiä" data-lang-key -elementillä
//     // -------------------------------------------------------------
//     const heading_element = document.createElement('h2');
//     heading_element.setAttribute('data-lang-key', 'manage_table');
//     // Haluamme otsikon ylimmäksi, joten prepend:
//     modalContent.prepend(heading_element);
//     // -------------------------------------------------------------

//     createModal({
//         // Tyhjennetään titleText, jotta modaalin otsikko haetaan data-lang-keyllä
//         titleDataLangKey: 'manage_table',
