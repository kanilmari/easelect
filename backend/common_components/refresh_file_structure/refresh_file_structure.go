...
func walk_and_refresh_file_structure(base_path string) (
	...
	// Määritellään embedding-rajoitus koskemaan koko prosessia
	// Jos tiedostorajoitus on täynnä, lopetetaan heti kävely
	embedding_count := 0
	...
	// Pieni apuvirhe salliaksemme kävelyn lopetuksen kesken
	...
	// Jos kävely loppui, tarkistetaan lopetettiinko vain rajoituksen täytyttyä
...
func insert_or_update_file_row(
	...
	// Lokitetaan, mikä tyyppi ja arvo on tulossa.
	log.Printf("openai_embedding: tyyppi=%T, arvo=%#v", openai_embedding, openai_embedding)
