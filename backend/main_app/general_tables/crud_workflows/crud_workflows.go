...
import (
	...
	"easelect/backend/main_app/general_tables/gt_2_column_crud/gt_2_column_create"
	"easelect/backend/main_app/general_tables/gt_2_column_crud/gt_2_column_delete"
