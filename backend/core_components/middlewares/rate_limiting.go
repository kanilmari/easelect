...
// 		`, funcName).Scan(&rateLimitAmount, &rateLimitMinutes)
// 		if err != nil {
// 			// Erotaan selkeästi noRows-tilanne muista virheistä
// 			if err == sql.ErrNoRows {
// 				log.Printf("\033[33mkehitys: funktiota '%s' ei löydy taulusta, ohitetaan rate-limitti\033[0m\n", funcName)
// 				next.ServeHTTP(w, r)
// 				return
// 			}
// 			// Lokitetaan punaisella muut virheet
// 			log.Printf("\033[31mvirhe: rate-limitin haku funktiolle='%s': %v\033[0m\n", funcName, err)
// 			next.ServeHTTP(w, r)
// 			return
// 		}
