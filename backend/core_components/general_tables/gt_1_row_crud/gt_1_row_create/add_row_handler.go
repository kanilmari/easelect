...
// // 			return fmt.Errorf("cache update error table=%s col=%s: %v", targetTblName, targetColName, err)
// // 		}
// // 	}
// // 	return nil
// // }
...
// // // 	err := r.ParseMultipartForm(50 << 20) // Sallit. esim. 50 MB
// // // 	if err != nil {
// // // 		fmt.Printf("\033[31m31mvirhe [add_row_handler.go] virhe:: %s\033[0m\n", err.Error())
// // // 		http.Error(w, "multipart parse error", http.StatusBadRequest)
// // // 		return
// // // 	}
...
// // // 	updateQ := fmt.Sprintf(`UPDATE %s SET filename=$1 WHERE id=$2`, pq.QuoteIdentifier(childTableName))
// // // 	if _, err := backend.Db.Exec(updateQ, newFileName, childRowID); err != nil {
// // // 		fmt.Printf("\033[31m31mvirhe [add_row_handler.go] virhe:: tiedostonimen päivitys tauluun=%s, id=%d: %s\033[0m\n", childTableName, childRowID, err.Error())
// // // 	}
// // // }
...
// // // 	rawUserID, ok := session.Values["user_id"]
// // // 	if !ok {
// // // 		fmt.Printf("\033[31m31mvirhe [add_row_handler.go] virhe:: käyttäjän ID puuttuu sessiosta\033[0m\n")
// // // 		return 0, fmt.Errorf("käyttäjän ID puuttuu sessiosta")
// // // 	}
// // // 	userID, ok := rawUserID.(int)
// // // 	if !ok {
// // // 		fmt.Printf("\033[31m31mvirhe [add_row_handler.go] virhe:: käyttäjän ID on väärää tyyppiä sessiossa\033[0m\n")
// // // 		return 0, fmt.Errorf("user ID invalid type in session")
// // // 	}
// // // 	return userID, nil
// // // }
