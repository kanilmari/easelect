...
// 	i := 1
// 	for col, val := range rowData {
// 		// 1) Käytetään virallista sarakenimeä
// 		insertColumns = append(insertColumns, pq.QuoteIdentifier(col))

// 		// 2) Tarkistetaan data_type
// 		colType := strings.ToLower(columnTypeMap[col])

// 		// 3) Jos geometry-tyyppiä, käytä ST_GeomFromText(...) -funktiota
// 		if strings.HasPrefix(colType, "geometry") {
// 			// Käsitellään tyhjät arvot => NULL
// 			// Huom. ts. jos val on "" tai nil => tallennetaan NULL, eikä ST_GeomFromText
// 			if val == nil || val == "" {
// 				placeholders = append(placeholders, "NULL")
// 				// Ei laiteta valuesiin mitään arvoa (koska ei tarvita $-placeholderia).
// 				// Hyppäämme suoraan seuraavaan sarakkeeseen:
// 				continue
// 			}

// 			// Muussa tapauksessa oletamme, että val on esim. "POINT(24.9384 60.1699)"
// 			placeholders = append(placeholders, fmt.Sprintf("ST_GeomFromText($%d, 4326)", i))
// 			values = append(values, val)
// 			i++
// 			continue
...
// 		// 4) Jos haluat muillekin sarakkeille "tyhjä merkkijono => NULL"
// 		//    voit tässä lisätä vastaavaa checkiä

// 		// 5) Muut sarakkeet => suoraan $%d
// 		placeholders = append(placeholders, fmt.Sprintf("$%d", i))
// 		values = append(values, val)
// 		i++
// 	}
...
// // // add_row_handler.go 2025-03-04--21-58
// // package gt_1_row_create
